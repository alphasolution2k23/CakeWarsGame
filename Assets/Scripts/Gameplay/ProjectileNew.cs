...
public class ProjectileNew : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //{
        // if (bTargetReady && TargetObjectTF != null)
        // {
        ...
        // else
        // {
        //    // Debug.Log("Target ReSelectady");
        //     ResetToInitialState();
        //     TargetObjectTF = GetTargetPosition();
        // }
        //// }
    ...
    {
        bTouchingGround = true;
        if (other.gameObject.CompareTag("Player") && shootByEnemy)
        {
            Debug.Log("PlayerHit");
            other.gameObject.GetComponent<PlayerControllerS>().DecreaseHealth(10f);

        }
        if (other.gameObject.CompareTag("enemy"))
        {
            other.GetComponent<EmeraldAISystem>().Damage(10);
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        //    //     enemies[0] = enemies[0].transform.GetChild(0).gameObject;
        //    //}
        //    //else
        //    //{
        ...
        //    {
        //        bTargetReady = false;
        //        return null; // Default to origin if no target found
        //    }
        ...
        //        Vector3 randomPoint = randomVectorOnGroundPlane * TargetRadius;
